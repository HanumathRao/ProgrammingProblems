...
public class RangeTree<K extends Comparable<K>> {
    ...
    private int compare(RangePair<K> leftRange,
        ...
        if (leftRange.second().compareTo(rightRange.first()) < 0 )
            ...
            if (leftRange.isSecondInclusive() && !rightRange.isFirstInclusive() &&
                leftRange.second().compareTo(rightRange.first()) == 0 )
                return -1;
            else if(rightRange.isSecondInclusive() && !leftRange.isFirstInclusive() &&
                rightRange.second().compareTo(leftRange.first()) == 0)
                return 1;
            else return 0;
